"""The config from the best bulk RNAseq experiment in GBM."""
...
def get_config():
    """Best composed config using bulk RNAseq data."""
    config = config_dict.ConfigDict()
    config.base_output_dir = Path("") # Add your output directory of the experiment results

    # Add your data config, setting up bulk RNAseq data loading and parameters
    ...
    config.experiment.experiment_name = "bulk_rnaseq_best1"
