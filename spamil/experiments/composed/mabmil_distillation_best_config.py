"""The config from the best mabmil distillation experiment in GBM."""
...
from spamil.experiments.config_trainer.mabmil_distillation_trainer_histo_visium_counts_survival import (
    set_trainer_config,
)
...
def get_config():
    """Best composed config using mabmil distillation."""
    ...
    config.experiment.experiment_name = "mabmil_distillation_best1"
    config.transform.train_transform_fn.n_genes = 500
    config.transform.train_transform_fn.select_based_on = "pseudobulk_variance"
