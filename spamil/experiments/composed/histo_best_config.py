"""The config from the best histology experiment in GBM."""
...
from spamil.experiments.config_trainer.abmil_trainer_histo_survival import (
    set_trainer_config,
)


def get_config():
    """Best composed config using histology data."""
    config = config_dict.ConfigDict()
    config.base_output_dir = Path("") # Add your output directory of the experiment results

    # Add your data config, setting up histology loading and parameters
    ...
    config.experiment.experiment_name = "histo_best1"
