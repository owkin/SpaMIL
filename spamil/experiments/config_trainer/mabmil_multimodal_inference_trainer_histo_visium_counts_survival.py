...
from spamil.models.mabmil_multimodal_inference import (
    MabMILMultimodalInference,
    MabMILMultimodalInferenceLoss,
)
...
def set_trainer_config(
    ...
    config.trainer = config_dict.ConfigDict(
        {
            ...
            "build_model_fn": {
                ...
                "_partial_": True,
                "module_constructor": {
                    "_target_": MabMILMultimodalInference,
                    "_partial_": True,
                    "out_features": 1,
                    "infer_with_histo": False,
                    "histo_feature_name": HISTO,
                    "visium_feature_name": VISIUM_COUNTS,
                    "task": "OS",
                    "d_model_attention_histo": 256,
                    "d_model_attention_visium": 256,
                    "temperature": 1.0,
                    "tiles_mlp_hidden_visium": None,
                    "tiles_mlp_hidden_histo": None,
                    "mlp_hidden": [128, 64],
                },
            },
    ...
    config.trainer.build_model_fn.loss_constructor = config_dict.ConfigDict(
        {
            "_target_": MabMILMultimodalInferenceLoss,
            "_partial_": True,
            "task": "OS",
